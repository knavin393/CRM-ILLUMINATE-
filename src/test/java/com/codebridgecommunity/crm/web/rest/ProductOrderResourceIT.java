...
class ProductOrderResourceIT {
    ...
    private static final String DEFAULT_PLACED_DATE = "AAAAAAAAAA";
    private static final String UPDATED_PLACED_DATE = "BBBBBBBBBB";
    ...
    void getAllProductOrders() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].placedDate")
            .value(hasItem(DEFAULT_PLACED_DATE))
            .jsonPath("$.[*].status")
