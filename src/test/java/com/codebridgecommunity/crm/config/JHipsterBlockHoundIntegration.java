...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.codebridgecommunity.crm.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.codebridgecommunity.crm.security.DomainUserDetailsService", "createSpringSecurityUser");
