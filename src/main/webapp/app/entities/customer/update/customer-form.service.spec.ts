      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            custName: expect.any(Object),
            gender: expect.any(Object),
            custIC: expect.any(Object),
            custEmail: expect.any(Object),
            custPhone: expect.any(Object),
            companyName: expect.any(Object),
            custJobTitle: expect.any(Object),
            engage: expect.any(Object),
