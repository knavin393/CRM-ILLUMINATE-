...
type CompanyFormGroupContent = {
  ...
  established: FormControl<ICompany['established']>;
  engage: FormControl<ICompany['engage']>;
};
...
export class CompanyFormService {
  createCompanyFormGroup(company: CompanyFormGroupInput = { id: null }): CompanyFormGroup {
    ...
    return new FormGroup<CompanyFormGroupContent>({
      ...
      established: new FormControl(companyRawValue.established, {
        validators: [Validators.required],
      }),
      engage: new FormControl(companyRawValue.engage),
    });
  }
