...
describe('Opportunity Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'opportunity', component: OpportunityComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to opportunityService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOpportunityIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOpportunityIdentifier).toHaveBeenCalledWith(entity);
